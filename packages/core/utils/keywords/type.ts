import { getTypeOf, JsonSchemaReducerParams, JsonSchemaValidatorParams, Keyword, SchemaNode } from "json-schema-library";
...
function validateType({ node, data, uiNode, pointer }: JsonSchemaValidatorParams & { uiNode?: object }) {
